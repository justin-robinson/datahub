...
class StoryRead extends \Entity\Entity\Base
{
     ...
     * Add Companies
     *
     * @param \Entity\Bizj\StoryEntityCompany $companies
     * @return StoryRead
     */
    public function addCompany(\Entity\Bizj\StoryEntityCompany $companies)
    {
     ...
     * @param \Entity\Bizj\StoryEntityCompany $companies
     */
    public function removeCompany(\Entity\Bizj\StoryEntityCompany $companies)
    {
     ...
     * Add People
     *
     * @param \Entity\Bizj\StoryPerson $people
     * @return StoryRead
     */
    public function addPerson(\Entity\Bizj\StoryPerson $people)
    {
        $this->People[] = $people;
     ...
     * @param \Entity\Bizj\StoryPerson $people
     */
    public function removePerson(\Entity\Bizj\StoryPerson $people)
    {
     ...
     * Add Industries
     *
     * @param \Entity\Bizj\StoryVerticalSubtopic $industries
     * @return StoryRead
     */
    public function addIndustry(\Entity\Bizj\StoryVerticalSubtopic $industries)
    {
     ...
     * @param \Entity\Bizj\StoryVerticalSubtopic $industries
     */
    public function removeIndustry(\Entity\Bizj\StoryVerticalSubtopic $industries)
    {
     ...
     * Add Images
     *
     * @param \Entity\Bizj\StoryImage $images
     * @return StoryRead
     */
    public function addImage(\Entity\Bizj\StoryImage $images)
    {
        $this->Images[] = $images;
     ...
     * @param \Entity\Bizj\StoryImage $images
     */
    public function removeImage(\Entity\Bizj\StoryImage $images)
    {
     ...
     *
     * @param \Entity\Bizj\StorySpecialCategory $specialCategories
     * @return StoryRead
     */
    public function addSpecialCategory(\Entity\Bizj\StorySpecialCategory $specialCategories)
    {
     ...
     * @param \Entity\Bizj\StorySpecialCategory $specialCategories
     */
    public function removeSpecialCategory(\Entity\Bizj\StorySpecialCategory $specialCategories)
    {
     ...
     * Add Corrections
     *
     * @param \Entity\Bizj\StoryCorrections $corrections
     * @return StoryRead
     */
    public function addCorrection(\Entity\Bizj\StoryCorrections $corrections)
    {
     ...
     * @param \Entity\Bizj\StoryCorrections $corrections
     */
    public function removeCorrection(\Entity\Bizj\StoryCorrections $corrections)
    {
