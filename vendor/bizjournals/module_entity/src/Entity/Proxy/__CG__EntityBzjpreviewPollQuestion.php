...
class PollQuestion extends \Entity\Bzjpreview\PollQuestion implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Bzjpreview\\PollQuestion' . "\0" . 'poll_question_id', '' . "\0" . 'Entity\\Bzjpreview\\PollQuestion' . "\0" . 'poll_id', '' . "\0" . 'Entity\\Bzjpreview\\PollQuestion' . "\0" . 'question', '' . "\0" . 'Entity\\Bzjpreview\\PollQuestion' . "\0" . 'position', '' . "\0" . 'Entity\\Bzjpreview\\PollQuestion' . "\0" . 'type', '' . "\0" . 'Entity\\Bzjpreview\\PollQuestion' . "\0" . 'required', '' . "\0" . 'Entity\\Bzjpreview\\PollQuestion' . "\0" . 'c_time', '' . "\0" . 'Entity\\Bzjpreview\\PollQuestion' . "\0" . 'Answers', '' . "\0" . 'Entity\\Bzjpreview\\PollQuestion' . "\0" . 'Poll'];
        }
