...
class StoryDeletes extends \Entity\Bizj\StoryDeletes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Bizj\\StoryDeletes' . "\0" . 'story_id', '' . "\0" . 'Entity\\Bizj\\StoryDeletes' . "\0" . 'c_time', '' . "\0" . 'Entity\\Bizj\\StoryDeletes' . "\0" . 'issue_date', '' . "\0" . 'Entity\\Bizj\\StoryDeletes' . "\0" . 'pub', '' . "\0" . 'Entity\\Bizj\\StoryDeletes' . "\0" . 'slug', '' . "\0" . 'Entity\\Bizj\\StoryDeletes' . "\0" . 'headline'];
        }
