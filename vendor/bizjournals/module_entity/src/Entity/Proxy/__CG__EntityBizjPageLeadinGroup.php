...
class PageLeadinGroup extends \Entity\Bizj\PageLeadinGroup implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'group_id', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'page_id', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'group_type', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'group_title', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'group_class', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'group_topic', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'group_teaser', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'placement', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'ord', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'group_url', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'auto_query', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'LeadinItems', '' . "\0" . 'Entity\\Bizj\\PageLeadinGroup' . "\0" . 'Page'];
        }
