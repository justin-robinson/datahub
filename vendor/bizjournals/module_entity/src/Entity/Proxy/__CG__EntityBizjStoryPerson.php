...
class StoryPerson extends \Entity\Bizj\StoryPerson implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\StoryPerson' . "\0" . 'story_id', '' . "\0" . 'Entity\\Bizj\\StoryPerson' . "\0" . 'c_time', '' . "\0" . 'Entity\\Bizj\\StoryPerson' . "\0" . 'person_id', '' . "\0" . 'Entity\\Bizj\\StoryPerson' . "\0" . 'weight', '' . "\0" . 'Entity\\Bizj\\StoryPerson' . "\0" . 'frequency', '' . "\0" . 'Entity\\Bizj\\StoryPerson' . "\0" . 'StoryRead');
        }
