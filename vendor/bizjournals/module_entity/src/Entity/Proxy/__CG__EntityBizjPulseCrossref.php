 ...
 */
class PulseCrossref extends \Entity\Bizj\PulseCrossref implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'ref_id', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'pulse_id', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'ref_type', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'ref_key', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'ref_value', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'ref_weight', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'created_at', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'updated_at', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'deleted_at', '' . "\0" . 'Entity\\Bizj\\PulseCrossref' . "\0" . 'Pulse');
        }
