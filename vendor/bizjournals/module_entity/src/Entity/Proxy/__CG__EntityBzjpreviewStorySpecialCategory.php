 ...
 */
class StorySpecialCategory extends \Entity\Bzjpreview\StorySpecialCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bzjpreview\\StorySpecialCategory' . "\0" . 'story_id', '' . "\0" . 'Entity\\Bzjpreview\\StorySpecialCategory' . "\0" . 'special_cat_id', '' . "\0" . 'Entity\\Bzjpreview\\StorySpecialCategory' . "\0" . 'c_time', '' . "\0" . 'Entity\\Bzjpreview\\StorySpecialCategory' . "\0" . 'StoryRead');
        }
