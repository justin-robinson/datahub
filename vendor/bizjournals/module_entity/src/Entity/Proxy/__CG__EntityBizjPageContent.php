 ...
 */
class PageContent extends \Entity\Bizj\PageContent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\PageContent' . "\0" . 'page_id', '' . "\0" . 'Entity\\Bizj\\PageContent' . "\0" . 'ord', '' . "\0" . 'Entity\\Bizj\\PageContent' . "\0" . 'content_type', '' . "\0" . 'Entity\\Bizj\\PageContent' . "\0" . 'content_html', '' . "\0" . 'Entity\\Bizj\\PageContent' . "\0" . 'word_count', '' . "\0" . 'Entity\\Bizj\\PageContent' . "\0" . 'Page');
        }
