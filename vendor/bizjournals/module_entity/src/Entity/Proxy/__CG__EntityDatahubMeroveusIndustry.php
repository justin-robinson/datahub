 ...
 */
class MeroveusIndustry extends \Entity\Datahub\MeroveusIndustry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Datahub\\MeroveusIndustry' . "\0" . 'meroveus_industry_id', '' . "\0" . 'Entity\\Datahub\\MeroveusIndustry' . "\0" . 'external_id', '' . "\0" . 'Entity\\Datahub\\MeroveusIndustry' . "\0" . 'industry'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MeroveusIndustry $proxy) {
