 ...
 */
class Page extends \Entity\Bizj\Page implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'page_id', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'site', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'path', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'slug', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'issue_date', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'release_time', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'created_at', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'updated_at', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'rev_number', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'headline', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'short_headline', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'is_premium', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'journal_id', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'type_id', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'parent_page_id', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'published_at', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'revised_at', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'allow_syndication', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'Contents', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'Corrections', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'Metadata', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'LeadinGroups', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'Crossrefs', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'LegacyMediaMap', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'Media', '' . "\0" . 'Entity\\Bizj\\Page' . "\0" . 'Urls');
        }
