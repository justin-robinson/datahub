 ...
 */
class StockExchange extends \Entity\Datahub\StockExchange implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Datahub\\StockExchange' . "\0" . 'id', '' . "\0" . 'Entity\\Datahub\\StockExchange' . "\0" . 'exchange_name', '' . "\0" . 'Entity\\Datahub\\StockExchange' . "\0" . 'exchange_abbrev', '' . "\0" . 'Entity\\Datahub\\StockExchange' . "\0" . 'yahoo_code');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StockExchange $proxy) {
    ...
    public function setExchangeAbbrev($exchangeAbbrev)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExchangeAbbrev', array($exchangeAbbrev));

        return parent::setExchangeAbbrev($exchangeAbbrev);
    }
    ...
    public function getExchangeAbbrev()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getExchangeAbbrev', array());

        return parent::getExchangeAbbrev();
    }
