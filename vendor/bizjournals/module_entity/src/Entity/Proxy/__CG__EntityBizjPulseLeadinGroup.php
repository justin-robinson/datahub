...
class PulseLeadinGroup extends \Entity\Bizj\PulseLeadinGroup implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'group_id', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'pulse_id', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'group_type', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'group_title', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'group_class', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'group_topic', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'group_teaser', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'placement', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'ord', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'group_url', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'auto_query', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'created_at', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'updated_at', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'deleted_at', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'LeadinItems', '' . "\0" . 'Entity\\Bizj\\PulseLeadinGroup' . "\0" . 'Pulse'];
        }
