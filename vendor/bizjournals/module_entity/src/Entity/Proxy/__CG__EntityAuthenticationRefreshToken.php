 ...
 */
class RefreshToken extends \Entity\Authentication\RefreshToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Authentication\\RefreshToken' . "\0" . 'token', '' . "\0" . 'Entity\\Authentication\\RefreshToken' . "\0" . 'client_id', '' . "\0" . 'Entity\\Authentication\\RefreshToken' . "\0" . 'service_id', '' . "\0" . 'Entity\\Authentication\\RefreshToken' . "\0" . 'expires_at', '' . "\0" . 'Entity\\Authentication\\RefreshToken' . "\0" . 'scope', '' . "\0" . 'Entity\\Authentication\\RefreshToken' . "\0" . 'created_at', '' . "\0" . 'Entity\\Authentication\\RefreshToken' . "\0" . 'Client', '' . "\0" . 'Entity\\Authentication\\RefreshToken' . "\0" . 'Service');
        }
