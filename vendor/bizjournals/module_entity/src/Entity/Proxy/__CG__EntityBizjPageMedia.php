...
class PageMedia extends \Entity\Bizj\PageMedia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'page_id', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'ord', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'media_host', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'media_uri', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'crop_data', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'media_source', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'external_id', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'media_type', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'title', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'caption', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'alt_text', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'link_url', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'art_credit', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'orig_height', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'orig_width', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'flag', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'additional_data', '' . "\0" . 'Entity\\Bizj\\PageMedia' . "\0" . 'Page'];
        }
