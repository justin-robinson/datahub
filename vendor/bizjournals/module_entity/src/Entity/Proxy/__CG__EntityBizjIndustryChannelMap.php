 ...
 */
class IndustryChannelMap extends \Entity\Bizj\IndustryChannelMap implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IndustryChannelMap $proxy) {
