...
class ProductEventMap extends \Entity\Bizjstatus\ProductEventMap implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Bizjstatus\\ProductEventMap' . "\0" . 'event_id', '' . "\0" . 'Entity\\Bizjstatus\\ProductEventMap' . "\0" . 'product_id', '' . "\0" . 'Entity\\Bizjstatus\\ProductEventMap' . "\0" . 'created_at', '' . "\0" . 'Entity\\Bizjstatus\\ProductEventMap' . "\0" . 'updated_at', '' . "\0" . 'Entity\\Bizjstatus\\ProductEventMap' . "\0" . 'Event', '' . "\0" . 'Entity\\Bizjstatus\\ProductEventMap' . "\0" . 'Product'];
        }
