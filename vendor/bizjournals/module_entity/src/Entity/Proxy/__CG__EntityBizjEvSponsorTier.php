 ...
 */
class EvSponsorTier extends \Entity\Bizj\EvSponsorTier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EvSponsorTier $proxy) {
    ...
    public function setOtherBenefits($otherBenefits)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOtherBenefits', [$otherBenefits]);

        return parent::setOtherBenefits($otherBenefits);
    }
    ...
    public function getOtherBenefits()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOtherBenefits', []);

        return parent::getOtherBenefits();
    }
    ...
    public function addSponsor(\Entity\Bizj\EvSponsor $sponsor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addSponsor', [$sponsor]);
    ...
    public function removeSponsor(\Entity\Bizj\EvSponsor $sponsor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeSponsor', [$sponsor]);
