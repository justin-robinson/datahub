 ...
 */
class PulseLeadinItem extends \Entity\Bizj\PulseLeadinItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'item_id', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'group_id', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'ord', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'item_page_id', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'url', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'headline', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'teaser', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'item_media_id', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'item_media_url', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'media_caption', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'media_alt_text', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'thumb_media_id', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'kicker', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'item_video_id', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'item_pulse_id', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'additional_data', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'created_at', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'updated_at', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'deleted_at', '' . "\0" . 'Entity\\Bizj\\PulseLeadinItem' . "\0" . 'LeadinGroup');
        }
