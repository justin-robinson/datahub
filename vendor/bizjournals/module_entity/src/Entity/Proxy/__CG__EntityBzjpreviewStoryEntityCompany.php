 ...
 */
class StoryEntityCompany extends \Entity\Bzjpreview\StoryEntityCompany implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bzjpreview\\StoryEntityCompany' . "\0" . 'id', '' . "\0" . 'Entity\\Bzjpreview\\StoryEntityCompany' . "\0" . 'story_id', '' . "\0" . 'Entity\\Bzjpreview\\StoryEntityCompany' . "\0" . 'name', '' . "\0" . 'Entity\\Bzjpreview\\StoryEntityCompany' . "\0" . 'eoc', '' . "\0" . 'Entity\\Bzjpreview\\StoryEntityCompany' . "\0" . 'c_time', '' . "\0" . 'Entity\\Bzjpreview\\StoryEntityCompany' . "\0" . 'normalized_name', '' . "\0" . 'Entity\\Bzjpreview\\StoryEntityCompany' . "\0" . 'StoryRead');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StoryEntityCompany $proxy) {
