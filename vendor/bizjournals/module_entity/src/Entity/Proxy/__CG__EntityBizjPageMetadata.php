 ...
 */
class PageMetadata extends \Entity\Bizj\PageMetadata implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\PageMetadata' . "\0" . 'meta_id', '' . "\0" . 'Entity\\Bizj\\PageMetadata' . "\0" . 'page_id', '' . "\0" . 'Entity\\Bizj\\PageMetadata' . "\0" . 'ord', '' . "\0" . 'Entity\\Bizj\\PageMetadata' . "\0" . 'meta_name', '' . "\0" . 'Entity\\Bizj\\PageMetadata' . "\0" . 'meta_value', '' . "\0" . 'Entity\\Bizj\\PageMetadata' . "\0" . 'Page');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageMetadata $proxy) {
