 ...
 */
class LegacyMedia extends \Entity\Bizj\LegacyMedia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'media_id', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'location_url', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'filename', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'media_type', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'mime_type', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'rev_number', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'default_height', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'default_width', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'default_caption', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'default_copyright', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'default_alt_text', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'content', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'filesize', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'created_at', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'updated_at', '' . "\0" . 'Entity\\Bizj\\LegacyMedia' . "\0" . 'PageLegacyMediaMap');
        }
