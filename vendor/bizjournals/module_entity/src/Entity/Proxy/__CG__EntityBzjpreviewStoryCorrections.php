 ...
 */
class StoryCorrections extends \Entity\Bzjpreview\StoryCorrections implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bzjpreview\\StoryCorrections' . "\0" . 'id', '' . "\0" . 'Entity\\Bzjpreview\\StoryCorrections' . "\0" . 'story_id', '' . "\0" . 'Entity\\Bzjpreview\\StoryCorrections' . "\0" . 'market', '' . "\0" . 'Entity\\Bzjpreview\\StoryCorrections' . "\0" . 'text', '' . "\0" . 'Entity\\Bzjpreview\\StoryCorrections' . "\0" . 'c_time', '' . "\0" . 'Entity\\Bzjpreview\\StoryCorrections' . "\0" . 'is_daily', '' . "\0" . 'Entity\\Bzjpreview\\StoryCorrections' . "\0" . 'StoryRead');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StoryCorrections $proxy) {
