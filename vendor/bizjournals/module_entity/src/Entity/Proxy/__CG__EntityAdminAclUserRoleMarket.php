 ...
 */
class AclUserRoleMarket extends \Entity\Admin\AclUserRoleMarket implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AclUserRoleMarket $proxy) {
