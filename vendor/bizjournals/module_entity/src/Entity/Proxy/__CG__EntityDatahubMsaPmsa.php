...
class MsaPmsa extends \Entity\Datahub\MsaPmsa implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Datahub\\MsaPmsa' . "\0" . 'sa_code', '' . "\0" . 'Entity\\Datahub\\MsaPmsa' . "\0" . 'sa_name', '' . "\0" . 'Entity\\Datahub\\MsaPmsa' . "\0" . 'sa_state', '' . "\0" . 'Entity\\Datahub\\MsaPmsa' . "\0" . 'is_combined', '' . "\0" . 'Entity\\Datahub\\MsaPmsa' . "\0" . 'parent_sa', '' . "\0" . 'Entity\\Datahub\\MsaPmsa' . "\0" . 'oneToMany', '' . "\0" . 'Entity\\Datahub\\MsaPmsa' . "\0" . 'manyToMany');
        }
