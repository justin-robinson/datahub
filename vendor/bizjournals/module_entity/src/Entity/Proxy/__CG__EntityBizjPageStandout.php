 ...
 */
class PageStandout extends \Entity\Bizj\PageStandout implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\PageStandout' . "\0" . 'page_id', '' . "\0" . 'Entity\\Bizj\\PageStandout' . "\0" . 'created_at');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageStandout $proxy) {
