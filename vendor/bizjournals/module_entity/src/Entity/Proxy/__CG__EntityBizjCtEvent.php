 ...
 */
class CtEvent extends \Entity\Bizj\CtEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'event_type', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'campaign_id', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'click_id', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'c_time', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'remote_ip', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'uin', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'user_agent', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'source_url', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'dest_url', '' . "\0" . 'Entity\\Bizj\\CtEvent' . "\0" . 'referer');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CtEvent $proxy) {
