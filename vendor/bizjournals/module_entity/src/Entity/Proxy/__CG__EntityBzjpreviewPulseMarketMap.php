 ...
 */
class PulseMarketMap extends \Entity\Bzjpreview\PulseMarketMap implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bzjpreview\\PulseMarketMap' . "\0" . 'pulse_id', '' . "\0" . 'Entity\\Bzjpreview\\PulseMarketMap' . "\0" . 'market_id', '' . "\0" . 'Entity\\Bzjpreview\\PulseMarketMap' . "\0" . 'created_at', '' . "\0" . 'Entity\\Bzjpreview\\PulseMarketMap' . "\0" . 'updated_at', '' . "\0" . 'Entity\\Bzjpreview\\PulseMarketMap' . "\0" . 'deleted_at', '' . "\0" . 'Entity\\Bzjpreview\\PulseMarketMap' . "\0" . 'Pulse');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PulseMarketMap $proxy) {
