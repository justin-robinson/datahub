...
class PageLegacyMediaMap extends \Entity\Bzjpreview\PageLegacyMediaMap implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'page_id', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'media_id', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'media_type', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'caption', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'alt_text', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'link_url', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'ord', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'title', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'flag', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'Page', '' . "\0" . 'Entity\\Bzjpreview\\PageLegacyMediaMap' . "\0" . 'Media'];
        }
