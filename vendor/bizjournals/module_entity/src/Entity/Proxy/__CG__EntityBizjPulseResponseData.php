 ...
 */
class PulseResponseData extends \Entity\Bizj\PulseResponseData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PulseResponseData $proxy) {
