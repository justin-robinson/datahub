...
class StoryVerticalSubtopic extends \Entity\Bzjpreview\StoryVerticalSubtopic implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Bzjpreview\\StoryVerticalSubtopic' . "\0" . 'story_id', '' . "\0" . 'Entity\\Bzjpreview\\StoryVerticalSubtopic' . "\0" . 'vertical_subtopic_id', '' . "\0" . 'Entity\\Bzjpreview\\StoryVerticalSubtopic' . "\0" . 'market', '' . "\0" . 'Entity\\Bzjpreview\\StoryVerticalSubtopic' . "\0" . 'story_date', '' . "\0" . 'Entity\\Bzjpreview\\StoryVerticalSubtopic' . "\0" . 'relevance', '' . "\0" . 'Entity\\Bzjpreview\\StoryVerticalSubtopic' . "\0" . 'is_daily', '' . "\0" . 'Entity\\Bzjpreview\\StoryVerticalSubtopic' . "\0" . 'StoryRead'];
        }
