 ...
 */
class Poll extends \Entity\Bzjpreview\Poll implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'poll_id', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'market', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'headline', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'teaser', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'start_time', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'end_time', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'active', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'display_results', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'recipients_final', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'recipients_daily', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'site_id', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'description', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'has_comments', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'has_sponsor', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'c_time', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'm_time', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'featured', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'site', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'path', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'meta_title', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'meta_description', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'meta_keywords', '' . "\0" . 'Entity\\Bzjpreview\\Poll' . "\0" . 'Questions');
        }
