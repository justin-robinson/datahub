 ...
 */
class Metadata extends \Entity\Bizj\Metadata implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Bizj\\Metadata' . "\0" . 'meta_id', '' . "\0" . 'Entity\\Bizj\\Metadata' . "\0" . 'object_type', '' . "\0" . 'Entity\\Bizj\\Metadata' . "\0" . 'object_id', '' . "\0" . 'Entity\\Bizj\\Metadata' . "\0" . 'meta_name', '' . "\0" . 'Entity\\Bizj\\Metadata' . "\0" . 'meta_value', '' . "\0" . 'Entity\\Bizj\\Metadata' . "\0" . 'created_at', '' . "\0" . 'Entity\\Bizj\\Metadata' . "\0" . 'updated_at');
        }
