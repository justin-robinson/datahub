 ...
 */
class CompanyMeroveusIndustryMap extends \Entity\Datahub\CompanyMeroveusIndustryMap implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Datahub\\CompanyMeroveusIndustryMap' . "\0" . 'hub_id', '' . "\0" . 'Entity\\Datahub\\CompanyMeroveusIndustryMap' . "\0" . 'meroveus_industry_id', '' . "\0" . 'Entity\\Datahub\\CompanyMeroveusIndustryMap' . "\0" . 'Company', '' . "\0" . 'Entity\\Datahub\\CompanyMeroveusIndustryMap' . "\0" . 'MeroveusIndustries'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompanyMeroveusIndustryMap $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addCompany(\Entity\Datahub\Company $company)
    {
     ...
     * {@inheritDoc}
     */
    public function removeCompany(\Entity\Datahub\Company $company)
    {
