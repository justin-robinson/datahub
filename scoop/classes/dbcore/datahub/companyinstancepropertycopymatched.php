...
/**
 * Class CompanyInstancePropertyCopyMatched
 ...
 * Put your code in DB\Datahub\CompanyInstancePropertyCopyMatched
 */
class CompanyInstancePropertyCopyMatched extends Model {

    const SCHEMA = 'datahub';
    const TABLE = 'companyInstanceProperty_copy_matched';
