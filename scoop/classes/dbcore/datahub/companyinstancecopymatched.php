...
/**
 * Class CompanyInstanceCopyMatched
 ...
 * Put your code in DB\Datahub\CompanyInstanceCopyMatched
 */
class CompanyInstanceCopyMatched extends Model {

    const SCHEMA = 'datahub';
    const TABLE = 'companyInstance_copy_matched';
