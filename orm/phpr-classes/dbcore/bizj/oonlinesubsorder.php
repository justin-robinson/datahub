...
/**
  ...
  * Put your code in OOnlineSubsOrder
  */
namespace DBCore\Bizj;

use phpr\Database\Model;

class OOnlineSubsOrder extends Model {

    const SCHEMA = 'bizj';
    const TABLE = 'o_online_subs_order';
    const AUTO_INCREMENT_COLUMN = 'online_subs_order_id';
    const PRIMARY_KEYS = 
        array (
          0 => 'online_subs_order_id',
        );
    ...
    public $online_subs_order_id = NULL;
    public $user_id = NULL;
