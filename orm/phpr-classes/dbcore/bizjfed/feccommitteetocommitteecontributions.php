...
/**
  ...
  * Put your code in FecCommitteeToCommitteeContributions
  */
namespace DBCore\Bizjfed;

use phpr\Database\Model;

class FecCommitteeToCommitteeContributions extends Model {

    const SCHEMA = 'bizjfed';
    const TABLE = 'fec_committee_to_committee_contributions';
